...
namespace IdentityManagerServerApi.Repositories
{
        ...
        IConfiguration config) : IUserAccount
    {
        public async Task<GeneralResponse> CreateAccount(UserDTO userDTO)
        {
            ...
            {
                Name = userDTO.Name,
                NroDocumento = userDTO.NroDocumento,
                PhoneNumber = userDTO.NroTelefono,
            ...
            if (!createUser.Succeeded) return new GeneralResponse(false, "Error ocurred: " + createUser);

            //asignamos rol por defecto, admin al primer registrado, el resto tendra rol usuario
        ...
        public async Task<LoginResponse> LoginAccount(LoginDTO loginDTO)
        {
            ...
            if (getUser is null) return new LoginResponse(false, null!, "Uesr not found");
